...
def Message processData(Message message) {
    ...
    builder.'ProcessContractRequestExternallyExportReply'(partition:AribaReply.PARTITION, variant:AribaReply.VARIANT){
        'ContractRequest_ProcessContractRequestExtValidationStatusResponseImport_Item'{
            'item'{
                'EventDetails'{
