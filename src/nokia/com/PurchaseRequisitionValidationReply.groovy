...
def Message processData(Message message) {
    ...
    builder.'ProcessRequisitionExternallyExportReply'(partition:AribaReply.PARTITION, variant:AribaReply.VARIANT){
        'Requisition_ProcessReqExtValidationStatusResponseImport_Item'{
            'item'{
                'EventDetails'{
